...
contract FheL {
    ...
    function _allowUserPosition(address user, euint64 collateral, euint64 debt) internal {
    ...
    function deposit(InEuint64 calldata encAmount) external {
        ...
        _allowUserPosition(msg.sender, p.collateral, p.debt);
    ...
    function liquidate(address user) external {
        ...
        _allowUserPosition(user, p.collateral, p.debt);
